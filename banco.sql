...
INSERT INTO trens (prefixo_trem, modelo_trem, ano_fabricacao, capacidade_toneladas, situacao_trem) VALUES
    ('LOC-1001', 'GE AC44i',        2014,  6200.00, 'ativo'),
    ('LOC-1002', 'EMD SD70ACe',     2011,  5800.50, 'manutencao'),
    ('LOC-1003', 'GE Dash 9',       2006,  5400.00, 'ativo'),
    ('AUT-2001', 'Automotriz VLI',  2019,   900.00, 'ativo'),
    ('LOC-1004', 'EMD GT46AC',      1999,  5100.75, 'inativo');